package com.mazhar.customnavigationdrawer2.widget;
...
import com.mazhar.customnavigationdrawer2.R;
...
public class SNavigationDrawer extends RelativeLayout{
    ...
    public void closeDrawer(){
        ...
        containerCV.animate().translationX(rootLayout.getX()).translationY(rootLayout.getY()).setDuration(400).start();
    ...
    public void openDrawer(){
        ...
        containerCV.animate().translationX(rootLayout.getX() +(rootLayout.getWidth() / 8)+ (rootLayout.getWidth() / 2) ).translationY(200).setDuration(400).start();
        final Handler handler = new Handler();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
